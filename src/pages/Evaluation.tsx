          ...
          <form className="multi-step-form" onSubmit={handleSubmit}>
            ...
            {step === 1 && (
              <div className="form-step fade-in">
                <h2 className="step-title">1. Temel Konum Bilgisi</h2>
            ...
            {step === 2 && (
              <div className="form-step fade-in">
                <h2 className="step-title">2. Fiziksel Veriler</h2>
            ...
            {step === 3 && (
              <div className="form-step fade-in">
                <h2 className="step-title">3. Statü ve Stratejik Kriterler</h2>
            ...
            {step === 4 && (
              <div className="form-step fade-in">
                <h2 className="step-title">4. İletişim Bilgileri</h2>
