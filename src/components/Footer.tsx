      ...
      <div className="container footer-container">
        <div className="footer-col brand-col">
          ...
          <div className="social-links mt-6">
            <a href="https://tr.linkedin.com/in/mahir-akar-256302224" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><Linkedin size={18} aria-hidden="true" /></a>
            <a href="https://www.instagram.com/mahirremax/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><Instagram size={18} aria-hidden="true" /></a>
          </div>
        </div>
        ...
        <div className="footer-col contact-col">
          ...
          <ul className="mt-4 contact-list">
            <li>
              <MessageCircle size={16} className="text-secondary" color="#25D366" aria-hidden="true" />
